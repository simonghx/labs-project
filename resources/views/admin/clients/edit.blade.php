...
@section('title', 'Admin - Update Client')
      ...
      <div class="box-body">
          ...
          @csrf
            ...
            <div class="form-group">
              ...
              @endif
              <input type="text" name="name" id="" class="form-control {{$errors->has('name')?'border-danger':''}}" placeholder="" value="{{old('name', $client->name)}}">
              </div>
              <div class="form-group">
                ...
                @endif
              <input class="form-control {{$errors->has('poste')?'border-danger':''}}" type="text" name="poste" id="" placeholder="" value="{{old('poste', $client->poste)}}">
              </div>
